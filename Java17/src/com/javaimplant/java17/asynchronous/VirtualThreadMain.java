...
public class VirtualThreadMain {
    public static void main(String[] args) {
        ...
        Runnable task = () -> System.out.println("Virtual Thread: " + Thread.currentThread().getName());
        Thread.startVirtualThread(task);
        Runnable threadTask = () -> System.out.println("Another Virtual Thread: " + Thread.currentThread().getName());
